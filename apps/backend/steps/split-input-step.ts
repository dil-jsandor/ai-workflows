...
export const splitInputStep = async (input: string): Promise<string> => {
    ...
    As an answer strictly send me only a string array (no further explanation) in json format where the elements should be the split string parts like {"results": ["section1", "section2"]}. The given text: ${input}`;
